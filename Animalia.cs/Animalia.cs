...
{
    public class Animalia : SteamCMDAgent
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            name = "WindowsGSM.Animalia", // WindowsGSM.XXXX
            author = "kessef",
            description = "WindowsGSM plugin for supporting Animalia Dedicated Server",
            version = "1.1",
            url = "https://github.com/dkdue/WindowsGSM.Animalia", // Github repository link (Best practice)
            color = "#34c9eb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => true;
        public override string AppId => "1664300"; // Game server appId, Animalia is 1664300

        // - Standard Constructor and properties
        public Animalia(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
        private readonly ServerConfig _serverData;
        public string Error, Notice;


        // - Game server Fixed variables
        public override string StartPath => @"AnimaliaSurvival/Binaries/Win64/AnimaliaSurvivalServer.exe"; // Game server start path
        public string FullName = "Animalia Dedicated Server"; // Game server FullName
